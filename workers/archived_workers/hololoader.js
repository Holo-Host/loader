...
async function handleRequest(request) {
  try {
    ...
    let JSONcombined = JSON.stringify(combined)
    let json = JSON.parse(JSONcombined)
    console.log('JSONcombined', json)

    //response = new Response(JSONcombined, JSONHeader)
    response = new Response(JSONcombined)
