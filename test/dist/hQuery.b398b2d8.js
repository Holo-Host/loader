...
var hQuery = function () {
  ...
  var getHappUrl = function getHappUrl() {
    return _url;
  };
  /**
   * DNA hash getter
  ...
  var getHappDna = function getHappDna() {
    return _dna;
  };
  /**
  ...
  var initHapp = function initHapp() {
    // Save url of hApp
    ...
    queryForHosts(_url).then(function (obj) {
      return processWorkerResponse(obj);
    }).then(function (r) {
      // Add protocol to hostname
      addr = 'ws://' + r;
      return fetchHappContent(r);
    }).then(function (html) {
      return replaceHtml(html, addr);
    })
    /*
    .catch(e => handleError({
        code: e.code
  ...
  var queryForHosts = function queryForHosts() {
    var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
    var dna = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  ...
  var processWorkerResponse = function processWorkerResponse(obj) {
    ...
    if (_typeof(obj.hosts) !== 'object' || obj.hosts.length === 0 || obj.hosts[0] === "") {
      throw {
        code: 503
      };
      return;
  ...
  var fetchHappContent = function fetchHappContent(addr) {
    // Fetch hApp content from selected HoloPort
    return fetch('//' + addr).then(function (r) {
      return r.text();
    });
  };
  /**
  ...
  var replaceHtml = function replaceHtml(html, addr) {
  ...
  var insertScripts = function insertScripts(html, url) {
    parser = new DOMParser();
    doc = parser.parseFromString(html, "text/html");
    var script = doc.createElement("script");
    script.src = "hClient.js";
    script.innerHTML = "hClient.overrideWebClient(".concat(url, ")");
...
},{}],"../../../.nvm/versions/node/v8.4.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.nvm/versions/node/v8.4.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../web/hQuery.js"], null)
//# sourceMappingURL=/hQuery.b398b2d8.map